...
def special(char_name, char_class):
    if char_class == 'warrior':
        return (f'{char_name} применил суперсилу «Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (f'{char_name} применил суперспособность «Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name} применил суперспособность «Защита {10 + 30}»')
