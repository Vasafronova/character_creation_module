...
def attack(char_name, char_class):
    """Функция, которая рассчитывает силу атаки."""
...
def defence(char_name, char_class):
    """Функция, которая рассчитывает силу защиты."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Функция, которая рассчитывает силу спецспособностей."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Функция, которая выводит тренировку."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Функция, которая описывает особенности персонажей."""
    approve_choice = None
    char_class = None
